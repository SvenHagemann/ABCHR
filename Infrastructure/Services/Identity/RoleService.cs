...
public class RoleService : IRoleService
{
    ...
    public RoleService(RoleManager<ApplicationRole> roleManager, IMapper mapper, UserManager<ApplicationUser> userManager, ApplicationDbContext context)
    {
    ...
    public async Task<IResponseWrapper> UpdateRolePermissionsAsync(UpdateRolePermissionsRequest request)
    {
        ...
        if (roleInDb is not null)
        {
            ...
            var permissionsToBeAssigned = request.RoleClaims.Where(rc => rc.IsAssignedToRole == true).ToList();
